module.requires.push('ui.ace'),
  module.config([
    ...
    (e) => {
      e.when('/realms/:realm/authz', {
        ...
        .when(
          '/realms/:realm/clients/:client/authz/resource-server/scope/:id',
          {
            templateUrl: `${resourceUrl}/partials/authz/resource-server-scope-detail.html`,
            resolve: { realm: (e) => e(), client: (e) => e() },
            controller: 'ResourceServerScopeDetailCtrl',
        ...
        .when(
          '/realms/:realm/clients/:client/authz/resource-server/permission',
          {
        ...
        .when(
          '/realms/:realm/identity-provider-settings/provider/:provider_id/:alias/permissions',
          {
            ...
            resolve: { realm: (e) => e(), identityProvider: (e) => e() },
  ...
  module.filter('unique', () => (e, r) => {
    if (!1 === r) return e;
    if ((r || angular.isUndefined(r)) && angular.isArray(e)) {
      var l = [],
        t = (e) => (angular.isObject(e) && angular.isString(r) ? e[r] : e);
      angular.forEach(e, (e) => {
        for (var r = !1, o = 0; o < l.length; o++)
          if (angular.equals(t(l[o]), t(e))) {
            r = !0;
            break;
          }
        r || l.push(e);
